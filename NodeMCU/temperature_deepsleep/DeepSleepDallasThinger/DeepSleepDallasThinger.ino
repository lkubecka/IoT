...
#define THING_USERNAME    "lkubecka"
#define THING_DEVICE_ID    "ESP_room_monitor"
#define THING_DEVICE_PSWD  "D7vhIRdvbqP5"

const char* AP_SSID = "sde";
const char* AP_PASSWORD = "anonbithdu";


ThingerSmartConfig thing(THING_USERNAME,THING_DEVICE_ID, THING_DEVICE_PSWD, false);  // false to disable using the BUILTIN_LED as it is connected to D0 as after connecting D0 to RST to enable deep-sleep it causes resets
